...
package Components
{
	...
	public class BgLayer extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			if (_layer == 1)
			{
				image1 = new Image(Assets.getTexture("bg" + _layer));
				image1.blendMode = BlendMode.NONE;
				image2 = new Image(Assets.getTexture("bg" + _layer));
				image2.blendMode = BlendMode.NONE;
			}
			else
			{
				image1 = new Image(Assets.getAtlas().getTexture("bg" + _layer));
				image2 = new Image(Assets.getAtlas().getTexture("bg" + _layer));
			}
